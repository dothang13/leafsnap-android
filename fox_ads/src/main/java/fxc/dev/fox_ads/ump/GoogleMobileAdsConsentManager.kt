...
import fxc.dev.fox_ads.BuildConfig
 ...
 */
internal class GoogleMobileAdsConsentManager private constructor(
    context: Context
) {
    ...
    val canRequestAds: Boolean
        get() = consentInformation.canRequestAds().also {
            Timber.d("Consent information can request ads: $it")
        }
